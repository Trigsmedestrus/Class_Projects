...
public class MainActivity extends ActionBarActivity {
    ...
    private long startingTime;      // let's us keep track of percent time left stuff.
...
//        initMenuOptions();
        ...
        countDownPeriod = startingTime = 30000;
        createTimer();
    }
    ...
    private void createTimer() {
        timer = new CountDownTimer(countDownPeriod, 1) {
            ...
            public void onFinish() {
                timer.cancel();
                pb.setProgress(0);
                Toast.makeText(MainActivity.this, "Ended Trip", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(MainActivity.this, ArrivalScreenActivity.class));
            }
    ...
    private void addToTimer() {
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startingTime = countDownPeriod + parseTimeString(selectedTime);
                ...
                createTimer();
                Toast.makeText(MainActivity.this, "Added " + selectedTime,
